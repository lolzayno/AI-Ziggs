                ...
                if item['participantId'] == participantid:
                    ...
                    if item_id in final_items:
                        if item_map[item_id]['status'] == 'completed' and item_map[item_id]['gold'] > 900:
                            item_list.append(item_map[item_id]['name'])  # Add completed items to item_list
                        else:
                            component_list.append(item_map[item_id])  # Add components to component_list
                        final_items = [item for item in final_items if item != item_id]
                    elif item_id == "3865":
                        if sup_id is None:
                            item_list.append(item_map[item_id]['name'])
                        else:
                            item_list.append(item_map[sup_id]['name'])
        ...
        with engine.begin() as connection:
            ...
            if row:
                ...
                connection.execute(text(""" 
                    ...
                    "bluetop_id": bluetop_id, "bluetop_champ": bluetop_champ, "bluetop_kills": bluetop_kills, "bluetop_deaths": bluetop_deaths, "bluetop_assists": bluetop_assists, "bluetop_kda": bluetop_kda, "bluetop_item0": bluetop_item0, "bluetop_item1": bluetop_item1, 
                    ...
                    "redtop_id": redtop_id, "redtop_champ": redtop_champ, "redtop_kills": redtop_kills, "redtop_deaths": redtop_deaths, "redtop_assists": redtop_assists, "redtop_kda": redtop_kda, "redtop_item0": redtop_item0, "redtop_item1": redtop_item1, 
                    ...
                    "bluejg_id": bluejg_id, "bluejg_champ": bluejg_champ, "bluejg_kills": bluejg_kills, "bluejg_deaths": bluejg_deaths, "bluejg_assists": bluejg_assists, "bluejg_kda": bluejg_kda,"bluejg_item0": bluejg_item0, "bluejg_item1": bluejg_item1, 
                    ...
                    "redjg_id": redjg_id, "redjg_champ": redjg_champ, "redjg_kills": redjg_kills, "redjg_deaths": redjg_deaths, "redjg_assists": redjg_assists, "redjg_kda": redjg_kda,"redjg_item0": redjg_item0, "redjg_item1": redjg_item1, 
                    ...
                    "bluemid_id": bluemid_id, "bluemid_champ": bluemid_champ, "bluemid_kills": bluemid_kills, "bluemid_deaths": bluemid_deaths, "bluemid_assists": bluemid_assists, "bluemid_kda": bluemid_kda, "bluemid_item0": bluemid_item0, "bluemid_item1": bluemid_item1, 
                    ...
                    "redmid_id": redmid_id, "redmid_champ": redmid_champ, "redmid_kills": redmid_kills, "redmid_deaths": redmid_deaths, "redmid_assists": redmid_assists, "redmid_kda": redmid_kda, "redmid_item0": redmid_item0, "redmid_item1": redmid_item1, 
                    ...
                    "bluebot_id": bluebot_id, "bluebot_champ": bluebot_champ, "bluebot_kills": bluebot_kills, "bluebot_deaths": bluebot_deaths, "bluebot_assists": bluebot_assists, "bluebot_kda": bluebot_kda, "bluebot_item0": bluebot_item0, "bluebot_item1": bluebot_item1, 
                    ...
                    "redbot_id": redbot_id, "redbot_champ": redbot_champ, "redbot_kills": redbot_kills, "redbot_deaths": redbot_deaths, "redbot_assists": redbot_assists, "redbot_kda": redbot_kda, "redbot_item0": redbot_item0, "redbot_item1": redbot_item1, 
                    ...
                    "bluesup_id": bluesup_id, "bluesup_champ": bluesup_champ, "bluesup_kills": bluesup_kills, "bluesup_deaths": bluesup_deaths, "bluesup_assists": bluesup_assists, "bluesup_kda": bluesup_kda, "bluesup_item0": bluesup_item0, "bluesup_item1": bluesup_item1, 
                    ...
                    "redsup_id": redsup_id, "redsup_champ": redsup_champ, "redsup_kills": redsup_kills, "redsup_deaths": redsup_deaths, "redsup_assists": redsup_assists, "redsup_kda": redsup_kda, "redsup_item0": redsup_item0, "redsup_item1": redsup_item1, 
